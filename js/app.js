(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".levels-block__slider")) new swiper_core_Swiper(".levels-block__slider", {
            ...
            if (document.querySelector(".casino-categories__slider")) new swiper_core_Swiper(".casino-categories__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        function initDoubleMenu() {
            ...
            function closeMenus() {
                menuItems.forEach((menu => {
                    if (menu.classList.contains(activeClass)) menu.classList.remove(activeClass);
                }));
            }
            document.addEventListener("click", (e => {
                if (e.target.closest(".item-menu__link") && e.target.closest("[data-double-menu]")) {
                    e.preventDefault();
                    !document.documentElement.classList.contains("menu-open") ? document.documentElement.classList.add("menu-open") : null;
                    if (e.target.classList.contains(activeClass)) menu.classList.remove(activeClass); else {
                        closeMenus();
